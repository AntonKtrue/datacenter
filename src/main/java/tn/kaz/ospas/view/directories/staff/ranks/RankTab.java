...
public class RankTab extends VerticalLayout {
    ...
    public RankTab() {
        ...
        final SimpleJPAContainer<TransneftRank> datasource = new SimpleJPAContainer<TransneftRank>(TransneftRank.class);
    ...
    private HorizontalLayout buildBarButtons(final SimpleJPAContainer<TransneftRank> datasource) {
